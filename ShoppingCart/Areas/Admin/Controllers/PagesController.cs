...
using ShoppingCart.Areas.Admin.Models.ViewModels.Pages;
using System;
...
namespace ShoppingCart.Areas.Admin.Controllers
{
    public class PagesController : Controller
    {
        ...
        public object ModelStyle { get; private set; }
        ...
        public ActionResult AddPage(PageVM model)
        {
            ...
            using (Db db = new Db())
            {
                ...
                //Check for and set for slug if it needed
        ...
        //GET : Admin/Pages/Delete Page/id
        ...
        //POST : Admin/Pages/Reorder Pages/id
        [HttpPost]
